...
| BPMN-процесс | [публичная TO-BE модель](docs/PROCESS_MODEL.md): инициатор → снабжение → финансы → бухгалтерия → контроль поставки; Tracker/Messenger отмечены как поддерживающая автоматизация |
